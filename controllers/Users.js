...
export const getUsers = async(req, res) => {
  ...
  try {
    const users = await Users.findAll({ // mencari semua user
      attributes:['id','image_user','name','email', 'role','phone','address','kampus','jenis_kelamin','tempat_lahir', 'tgl_lahir', 'tempat_lahir', 'agama', 'program_studi', 'jenjang','createdAt','updatedAt']
    });
...
try {
  const users = await Users.findOne({ // mencari single user berdasarkan id params
    ...
    attributes:['id','image_user','name','email', 'role','phone','address','kampus','jenis_kelamin','tempat_lahir', 'tgl_lahir', 'tempat_lahir', 'agama', 'program_studi', 'jenjang','createdAt','updatedAt'] //kemudian menampilkan atributnya
  });
  res.json(users); //respon berupa json
} catch (error) {
console.log(error); // jika error
...
export const Whoami = async (req, res) => {
    try {
        const users = await Users.findOne({ // Mencari user yang sedang login
            ...
            attributes:['image_user','name','email', 'role','phone','address','kampus','jenis_kelamin','tempat_lahir', 'tgl_lahir', 'tempat_lahir', 'agama', 'program_studi', 'jenjang'] // menampilkan atribut
        });
